...
var ngAdminLTE = angular.module('ngAdminLTE', [
    'ngResource',
    'ngCookies',
    'ngSanitize',
    'ngStorage',
...
// Angular ui-router
ngAdminLTE.config(['$stateProvider', '$urlRouterProvider', '$locationProvider',
    function($stateProvider, $urlRouterProvider, $locationProvider) {
        ...
        $stateProvider
            ...
            .state('users', {
                url: '/users',
                templateUrl: 'partials/system/users.html',
                controller: 'UserController'
            })

            .state('groups', {
                url: '/groups',
                templateUrl: 'partials/system/groups.html',
...
ngAdminLTE.controller('MainController', function ($scope, $rootScope, $location, $translate, $localStorage, $sessionStorage, Constants) {
    // 重设左侧导航栏样式
